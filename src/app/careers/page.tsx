...
export const metadata: Metadata = {
  title: "Director of Operations — WHALEN Financial",
  description: "We're hiring a Director of Operations to partner with our Founder and scale a growing wealth management firm. $130K–$160K base + bonus.",
};
      ...
      <header style={{
        ...
        <div style={{ maxWidth: 860, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: 12, marginBottom: 28 }}>
            {["Full-Time", "Remote", "$130K – $160K Base", "Las Vegas, NV (or Remote)"].map(tag => (
          ...
          <p style={{ fontSize: 18, fontWeight: 300, lineHeight: 1.75, color: "rgba(255,255,255,.6)", maxWidth: 620, margin: 0 }}>
            A hands-on leadership role for someone who thrives on execution, accountability, and building structure in a fast-growing firm.
          </p>
        </div>
      </header>
      ...
      <main style={{ background: "#080f1a", padding: "60px 56px 100px" }}>
        <div style={{ maxWidth: 860, margin: "0 auto", display: "flex", flexDirection: "column", gap: 52 }}>
          ...
          <section>
            ...
            <p style={{ fontSize: 15, fontWeight: 300, lineHeight: 1.85, color: "rgba(255,255,255,.6)", marginBottom: 14 }}>
              This is a hands-on leadership role focused on execution, accountability, and operational excellence. You will work directly with the Founder to:
            </p>
            ...
            <p style={{ fontSize: 15, fontWeight: 300, lineHeight: 1.85, color: "rgba(255,255,255,.5)", marginTop: 16, fontStyle: "italic" }}>
              This role is ideal for someone who thrives in a fast-paced environment, enjoys building structure, and wants to play a key role in scaling a growing firm.
            </p>
          </section>
          ...
          <section>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 28 }}>
              {[
                ...
                <div key={section.title} style={{ background: "rgba(255,255,255,.03)", border: "1px solid rgba(255,255,255,.07)", borderRadius: 4, padding: "28px 28px 24px" }}>
          ...
          <section style={{ background: "rgba(255,255,255,.02)", border: "1px solid rgba(255,255,255,.06)", borderRadius: 4, padding: "28px 28px 24px" }}>
            ...
            <p style={{ fontSize: 14, fontWeight: 400, color: "rgba(255,255,255,.7)", marginTop: 16, lineHeight: 1.75 }}>
              This is a <strong style={{ color: "#fff" }}>builder and operator role</strong> — you will be expected to lead, execute, and drive results.
            </p>
          </section>
          ...
          <section>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }} className="qual-grid">
              <div style={{ background: "rgba(255,255,255,.03)", border: "1px solid rgba(255,255,255,.07)", borderRadius: 4, padding: "24px 24px 20px" }}>
          ...
          <section>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 20 }} className="comp-grid">
              <div style={{ background: "rgba(0,153,204,.07)", border: "1px solid rgba(0,153,204,.2)", borderRadius: 4, padding: "24px 24px" }}>
                <div style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 36, fontWeight: 300, color: "#fff", marginBottom: 4 }}>$130K – $160K</div>
                <div style={{ fontSize: 12, fontWeight: 500, letterSpacing: ".08em", textTransform: "uppercase", color: "#0099CC" }}>Competitive Base Salary</div>
              </div>
              <div style={{ background: "rgba(255,255,255,.03)", border: "1px solid rgba(255,255,255,.07)", borderRadius: 4, padding: "24px 24px" }}>
                <div style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 24, fontWeight: 300, color: "#fff", marginBottom: 4 }}>Performance Bonus</div>
                <div style={{ fontSize: 13, fontWeight: 300, color: "rgba(255,255,255,.5)", lineHeight: 1.65 }}>Tied to firm growth and operational success, with potential for future equity participation.</div>
              </div>
            </div>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
              {["401(k) + Matching", "Health Insurance", "Dental & Vision", "Paid Time Off", "Parental Leave", "Relocation Assistance"].map(b => (
          ...
          <section style={{ background: "rgba(0,153,204,.06)", border: "1px solid rgba(0,153,204,.2)", borderRadius: 4, padding: "44px 40px", textAlign: "center" }}>
            ...
            <p style={{ fontSize: 15, fontWeight: 300, color: "rgba(255,255,255,.5)", lineHeight: 1.75, marginBottom: 32, maxWidth: 480, margin: "0 auto 32px" }}>
              ...
              with the subject line <strong style={{ color: "rgba(255,255,255,.7)" }}>&ldquo;Director of Operations&rdquo;</strong>.
            </p>
            <a href="mailto:info@whalenfinancial.com?subject=Director%20of%20Operations%20Application" style={{
