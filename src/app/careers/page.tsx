        ...
        <div style={{ maxWidth: 860, margin: "0 auto" }}>
          ...
          {hasOpenings ? (
            ...
            <div style={{
              ...
              <div style={{ fontSize: 11, fontWeight: 600, letterSpacing: ".18em", textTransform: "uppercase", color: "#0099CC", marginBottom: 16 }}>
                Currently Closed
              </div>
              <h2 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 32, fontWeight: 300, color: "#fff", lineHeight: 1.2, marginBottom: 16 }}>
                No open positions at this time
              </h2>
              <p style={{ fontSize: 15, fontWeight: 300, lineHeight: 1.8, color: "rgba(255,255,255,.55)", maxWidth: 520, margin: "0 auto" }}>
                We&rsquo;re not actively hiring right now, but we&rsquo;re always interested in meeting people who share our mission. Send your resume below and we&rsquo;ll keep it on file.
              </p>
            </div>
          )}
          ...
          <div style={{ marginTop: 48, paddingTop: 48, borderTop: "1px solid rgba(255,255,255,.07)" }}>
            <p style={{ fontSize: 14, fontWeight: 300, color: "rgba(255,255,255,.35)", lineHeight: 1.8 }}>
              {hasOpenings ? "Don’t see the right role? Send" : "Send"} your resume to{" "}
